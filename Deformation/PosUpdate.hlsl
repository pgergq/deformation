...
void PosUpdate(uint3 DTid : SV_DispatchThreadID)
{
	...
	float3 npos1 = indexer[DTid.x].nw1[0] * volcube1[ind1].newpos.xyz +
		...
		indexer[DTid.x].nw1[2] * volcube1[ind1 + vcwidth].newpos.xyz +
		indexer[DTid.x].nw1[3] * volcube1[ind1 + vcwidth + 1].newpos.xyz +
		indexer[DTid.x].nw1[4] * volcube1[ind1 + vcwidth*vcwidth].newpos.xyz +
		indexer[DTid.x].nw1[5] * volcube1[ind1 + vcwidth*vcwidth + 1].newpos.xyz +
		indexer[DTid.x].nw1[6] * volcube1[ind1 + vcwidth*vcwidth + vcwidth].newpos.xyz +
		indexer[DTid.x].nw1[7] * volcube1[ind1 + vcwidth*vcwidth + vcwidth + 1].newpos.xyz;
	float3 npos2 = indexer[DTid.x].nw2[0] * volcube2[ind2].newpos.xyz +
		indexer[DTid.x].nw2[1] * volcube2[ind2 + 1].newpos.xyz +
		indexer[DTid.x].nw2[2] * volcube2[ind2 + (vcwidth + 1)].newpos.xyz +
		indexer[DTid.x].nw2[3] * volcube2[ind2 + (vcwidth + 1) + 1].newpos.xyz +
		indexer[DTid.x].nw2[4] * volcube2[ind2 + (vcwidth + 1)*(vcwidth + 1)].newpos.xyz +
		indexer[DTid.x].nw2[5] * volcube2[ind2 + (vcwidth + 1)*(vcwidth + 1) + 1].newpos.xyz +
		indexer[DTid.x].nw2[6] * volcube2[ind2 + (vcwidth + 1)*(vcwidth + 1) + (vcwidth + 1)].newpos.xyz +
		indexer[DTid.x].nw2[7] * volcube2[ind2 + (vcwidth + 1)*(vcwidth + 1) + (vcwidth + 1) + 1].newpos.xyz;
